...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/entrelacados.git"
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/entrelacados"
...
set :local_domain, 'entrelacados.art.com.br'
